...
type IdentityDump struct {

	Identity IdentityDumpIdentity `json:"identity,omitempty"`

	Network IdentityDumpNetwork `json:"network,omitempty"`

	Conduits []IdentityDumpNetwork `json:"conduits,omitempty"`
}
